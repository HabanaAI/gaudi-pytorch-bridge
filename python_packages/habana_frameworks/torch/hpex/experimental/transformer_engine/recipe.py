...
#
# Changes:
# - Disabled override_linear_precision
...
class DelayedScaling:
    ...
    * The scaling factor should always be a power of 2 to not introduce numerical
    ...
    def __post_init__(self) -> None:
        ...
        assert self.override_linear_precision in ((False, False, False),), "No override is currently supported."
