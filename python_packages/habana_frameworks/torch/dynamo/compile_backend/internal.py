...
def optimize_pre_partitioner(
    ...
    """
    optimize_graph(
        OptimizationPassPlacement.PRE_PARTITIONER, graph_module, example_inputs, is_training, is_backward, uses_aot
    )
...
def optimize_post_partitioner(
    ...
    """
    optimize_graph(
        OptimizationPassPlacement.POST_PARTITIONER, graph_module, example_inputs, is_training, is_backward, uses_aot
    )
...
def partition_module(
    ...
    """
    optimize_graph(
        OptimizationPassPlacement.PARTITIONER, graph_module, example_inputs, is_training, is_backward, uses_aot
    )
