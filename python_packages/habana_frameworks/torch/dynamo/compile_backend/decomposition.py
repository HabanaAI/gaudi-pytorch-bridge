...
hpu_backend_decompositions_common = get_decompositions(
    [
        ...
        # aten.embedding_dense_backward,#appears in PT decomps eventhough it is a core aten op
        aten.embedding_dense_backward.out,
        aten.empty_like,
        # aten._euclidean_dist.default,#PT decomposes it, but hpu has a custom decomposition using cdist_forward
        aten.expand_as,
        aten.eye,
        aten.eye.out,
        aten.fill.Scalar,  # core aten
        aten.fill.Tensor,
        aten.fill_,
        # aten.floor_divide,#adding this as in PT FW decomps list causes failues in HPU tests
        aten.frac,
        aten.frac.out,
        aten.frac_.default,
        ...
        # aten.glu,#adding this causes hpu CI test failures with eager FB of floordiv
        ...
        # aten.heaviside,#blocked by - isnan_fwd_i32 doesn't support DS
        # aten.heaviside_,#blocked by - isnan_fwd_i32 doesn't support DS
        aten.heaviside.out,
