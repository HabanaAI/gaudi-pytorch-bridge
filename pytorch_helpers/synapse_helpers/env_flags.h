...
ENV_STRING_STRUCT_DEFINITION(PT_HPU_GRAPH_FUSION_OPS_FILE, "");
ENV_STRUCT_DEFINITION(HABANA_PGM_LRU_MAX, unsigned, 0);
ENV_STRUCT_DEFINITION(HABANA_PGM_DUMP_TENSOR_NUMEL, unsigned, 0);
ENV_STRING_STRUCT_DEFINITION(HABANA_PGM_WATCHLIST_FILE, "");
ENV_STRUCT_DEFINITION(PT_HPU_LAZY_CACHE_DISABLE, bool, false);
ENV_STRUCT_DEFINITION(PT_HPU_CACHE_RECIPE_WITH_SCALAR, bool, true);
ENV_STRING_STRUCT_DEFINITION(PT_HPU_PLACE_ON_CPU, "");
ENV_STRING_STRUCT_DEFINITION(HABANA_TRANSFORM_GRAPH_FILE, "");
