...
ENV_STRUCT_DEFINITION(PT_HPU_ENABLE_VIEW_TABLE, bool, true);
...
ENV_STRUCT_DEFINITION(PT_HPU_ENABLE_TRANSPOSE_WITH_STRIDED_VIEW, bool, false);
...
ENV_STRUCT_DEFINITION(PT_HPU_ENABLE_STAGE_SUBMISSION, bool, false);
...
ENV_STRUCT_DEFINITION(PT_HPU_ENABLE_LAZY_COLLECTIVES, bool, true);
