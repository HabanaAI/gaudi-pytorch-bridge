...
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_ENABLE_VIEW_TABLE, bool);
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_LOG_LEVEL_ALL, int);
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_LOG_TYPE, int);
...
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_USE_HCL_SYNC, bool);
ENV_STRUCT_STATIC_DEFINITION(PT_USE_HCL_OPTS, bool);
...
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_EVALUATE_PERSISTENT_TENS_WITH_MS, bool);
...
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_ENABLE_ADHOC_GROUPS, bool);
} // namespace new_style
