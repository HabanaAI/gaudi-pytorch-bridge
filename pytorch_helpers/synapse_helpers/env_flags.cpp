...
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_POOL_MEM_THRESHOLD_PERC, unsigned);
...
ENV_STRING_STRUCT_STATIC_DEFINITION(PT_HPU_GRAPH_FUSION_OPS_FILE);
ENV_STRUCT_STATIC_DEFINITION(HABANA_PGM_LRU_MAX, unsigned);
ENV_STRUCT_STATIC_DEFINITION(HABANA_PGM_DUMP_TENSOR_NUMEL, unsigned);
ENV_STRING_STRUCT_STATIC_DEFINITION(HABANA_PGM_WATCHLIST_FILE);
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_LAZY_CACHE_DISABLE, bool);
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_CACHE_RECIPE_WITH_SCALAR, bool);
ENV_STRING_STRUCT_STATIC_DEFINITION(PT_HPU_PLACE_ON_CPU);
ENV_STRING_STRUCT_STATIC_DEFINITION(HABANA_TRANSFORM_GRAPH_FILE);
