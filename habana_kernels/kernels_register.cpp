                           ...
                           RegisterOperators()
                               ...
                               .op(torch::
                                       RegisterOperators::options()
                                           ...
                                           .impl_unboxedOnlyKernel<
                                               ...
                                               &add_tensor_hpu_wrap_>(DispatchKey::
                                                                          HABANATensorId)
                                           .aliasAnalysis(
                                               c10::AliasAnalysisKind::FROM_SCHEMA))
                               .op(torch::RegisterOperators::options()
                               ...
                               .op(torch::RegisterOperators::options()
                                       ...
                                       .impl_unboxedOnlyKernel<
                                           ...
                                           &add_scalar_hpu_wrap_>(DispatchKey::
                                                                      HABANATensorId)
                                       .aliasAnalysis(
                                           c10::AliasAnalysisKind::FROM_SCHEMA))
                               .op(torch::RegisterOperators::options()
                               ...
                               .op(torch::RegisterOperators::options()
                                       ...
                                       .impl_unboxedOnlyKernel<
                                           ...
                                           &sub_tensor_hpu_wrap_>(DispatchKey::
                                                                      HABANATensorId)
                                       .aliasAnalysis(
                                           c10::AliasAnalysisKind::FROM_SCHEMA))
                               .op(torch::RegisterOperators::options()
                               ...
                               .op(torch::RegisterOperators::options()
                                       ...
                                       .impl_unboxedOnlyKernel<
                                           ...
                                           &sub_scalar_hpu_wrap_>(DispatchKey::
                                                                      HABANATensorId)
                                       .aliasAnalysis(
                                           c10::AliasAnalysisKind::FROM_SCHEMA))
                               .op(torch::RegisterOperators::options()
                                       ...
                                       .impl_unboxedOnlyKernel<
                                           ...
                                           &mul_tensor_hpu_wrap_>(DispatchKey::
                                                                      HABANATensorId)
                                       .aliasAnalysis(
                                           c10::AliasAnalysisKind::FROM_SCHEMA))
                               .op(torch::RegisterOperators::options()
                               ...
                               .op(torch::RegisterOperators::options()
                                       ...
                                       .impl_unboxedOnlyKernel<
                                           ...
                                           &mul_scalar_hpu_wrap_>(DispatchKey::
                                                                      HABANATensorId)
                                       .aliasAnalysis(
                                           c10::AliasAnalysisKind::FROM_SCHEMA))
                               .op(torch::RegisterOperators::options()
                               ...
                               .op(torch::RegisterOperators::options()
                                       ...
                                       .impl_unboxedOnlyKernel<
                                           ...
                                           &div_tensor_hpu_wrap_>(DispatchKey::
                                                                      HABANATensorId)
                                       .aliasAnalysis(
                                           c10::AliasAnalysisKind::FROM_SCHEMA))
                               .op(torch::RegisterOperators::options()
                               ...
                               .op(torch::RegisterOperators::options()
                                       ...
                                       .impl_unboxedOnlyKernel<
                                           ...
                                           &div_scalar_hpu_wrap_>(DispatchKey::
                                                                      HABANATensorId)
                                       .aliasAnalysis(
                                           c10::AliasAnalysisKind::FROM_SCHEMA))
                               .op(torch::RegisterOperators::options()
                               ...
                               .op(torch::RegisterOperators::options()
                                       ...
                                       .impl_unboxedOnlyKernel<
                                           ...
                                           &rsub_scalar_hpu_wrap>(DispatchKey::
                                                                      HABANATensorId)
                                       .aliasAnalysis(
                                           c10::AliasAnalysisKind::FROM_SCHEMA))
                               .op(torch::RegisterOperators::options()
                               ...
                               .op(torch::RegisterOperators::options()
                                       ...
                                       .impl_unboxedOnlyKernel<
                                           ...
                                           &convolution_hpu_wrap>(DispatchKey::
                                                                      HABANATensorId)
                                       .aliasAnalysis(
                                           c10::AliasAnalysisKind::FROM_SCHEMA))
                               .op(torch::RegisterOperators::options()
                               ...
                               .op(torch::RegisterOperators::options()
                                       ...
                                       .impl_unboxedOnlyKernel<
                                           ...
                                           &scatter_src_hpu_wrap>(DispatchKey::
                                                                      HABANATensorId)
                                       .aliasAnalysis(
                                           c10::AliasAnalysisKind::FROM_SCHEMA))
                               .op(torch::RegisterOperators::options()
