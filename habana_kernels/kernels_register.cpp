    ...
    torch::RegisterOperators()
        ...
        .op(torch::RegisterOperators::options()
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &add_scalar_hpu_wrap_>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &sub_tensor_hpu_wrap>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &sub_tensor_hpu_wrap_>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &sub_scalar_hpu_wrap>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &sub_scalar_hpu_wrap_>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
        ...
        .op(torch::RegisterOperators::options()
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &mul_scalar_hpu_wrap_>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &masked_scale_hpu_wrap>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema("aten::div.Tensor(Tensor self, Tensor other) -> Tensor")
                .impl_unboxedOnlyKernel<
                    decltype(div_tensor_hpu_wrap),
                    &div_tensor_hpu_wrap>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &div_tensor_hpu_wrap_out>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &div_tensor_hpu_wrap_>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema("aten::div.Scalar(Tensor self, Scalar other) -> Tensor")
                .impl_unboxedOnlyKernel<
                    decltype(div_scalar_hpu_wrap),
                    &div_scalar_hpu_wrap>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &div_scalar_hpu_wrap_>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &pow_tensor_tensor_hpu_wrap>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &pow_tensor_tensor_hpu_wrap_>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &pow_tensor_scalar_hpu_wrap>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &pow_tensor_scalar_hpu_wrap_>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &pow_scalar_tensor_hpu_wrap>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
        ...
        .op(torch::RegisterOperators::options()
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &convolution_hpu_wrap>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &convolution_backward_hpu_wrap>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &embedding_bag_hpu_wrap>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &embedding_bag_bwd_hpu_wrap>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &constant_pad_hpu_wrap>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &embedding_hpu_wrap>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
        ...
        .op(torch::RegisterOperators::options()
                ...
                .impl_unboxedOnlyKernel<
                    decltype(embedding_bag_sum_bwd_out_hpu_wrap),
        ...
        .op(torch::RegisterOperators::options()
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &fill_hpu_wrap_>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &masked_fill_hpu_wrap_>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &masked_fill_scalar_hpu_wrap_>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &index_select_hpu_wrap>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &index_put_hpu_wrap_>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &index_put_hpu_wrap>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &index_add_hpu_wrap_>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &scatter_inplace_src_hpu_wrap>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &scatter_src_hpu_wrap>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &gather_src_hpu_wrap>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &scatter_add_src_hpu_wrap>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
        ...
        .op(torch::RegisterOperators::options()
                ...
                .impl_unboxedOnlyKernel<decltype(mm_hpu_wrap), &mm_hpu_wrap>(
                    DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
        ...
        .op(torch::RegisterOperators::options()
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &batch_gemm_out_hpu_wrap>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
        ...
        .op(torch::RegisterOperators::options()
                ...
                .impl_unboxedOnlyKernel<decltype(dot_hpu_wrap), &dot_hpu_wrap>(
                    DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema("aten::mv(Tensor self, Tensor vec)->Tensor")
                .impl_unboxedOnlyKernel<decltype(mv_hpu_wrap), &mv_hpu_wrap>(
                    DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &nll_loss_forward_hpu_wrap>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &nll_loss_backward_hpu_wrap>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &mse_loss_forward_hpu_wrap>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &mse_loss_backward_hpu_wrap>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &binary_cross_entropy_hpu_wrap>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
        ...
        .op(torch::RegisterOperators::options()
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &batch_norm_bwd_hpu_wrap>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
        ...
        .op(torch::RegisterOperators::options()
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &layer_norm_backward_hpu_wrap>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
        ...
        .op(torch::RegisterOperators::options()
                ...
                .impl_unboxedOnlyKernel<
                    decltype(max_pool2d_with_indices_backward_out_hpu_wrap),
        ...
        .op(torch::RegisterOperators::options()
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &avg_pool2d_backward_hpu_wrap>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
        ...
        .op(torch::RegisterOperators::options()
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &bernoulli_scalar_hpu_wrap>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &fused_dropout_hpu_wrap>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &sum_dim_IntList_hpu_wrap>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
        ...
        .op(torch::RegisterOperators::options()
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &sum_IntList_out_hpu_wrap>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
        ...
        .op(torch::RegisterOperators::options()
                ...
                .impl_unboxedOnlyKernel<decltype(sum_hpu_wrap), &sum_hpu_wrap>(
                    DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
        ...
        .op(torch::RegisterOperators::options()
                ...
                .impl_unboxedOnlyKernel<decltype(any_hpu_wrap), &any_hpu_wrap>(
                    DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
        ...
        .op(torch::RegisterOperators::options()
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &habana::softmax_hpu_wrap>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
        ...
        .op(torch::RegisterOperators::options()
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &at::native::empty_hpu_wrap>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
        ...
        .op(torch::RegisterOperators::options()
                ...
                .impl_unboxedOnlyKernel<decltype(cat_hpu_wrap), &cat_hpu_wrap>(
                    DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
        ...
        .op(torch::RegisterOperators::options()
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &split_with_sizes_hpu_wrap>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
        ...
        .op(torch::RegisterOperators::options()
                ...
                .impl_unboxedOnlyKernel<decltype(t_hpu_wrap), &t_hpu_wrap>(
                    DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema("aten::t_(Tensor(a!) self) -> Tensor(a!)")
                .impl_unboxedOnlyKernel<decltype(t_hpu_wrap_), &t_hpu_wrap_>(
                    DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &threshold_backward_hpu_wrap>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
        ...
        .op(torch::RegisterOperators::options()
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &sigmoid_backward_hpu_wrap>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
        ...
        .op(torch::RegisterOperators::options()
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &tanh_backward_hpu_wrap>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
        ...
        .op(torch::RegisterOperators::options()
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &gelu_backward_hpu_wrap>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
        ...
        .op(torch::RegisterOperators::options()
                ...
                .impl_unboxedOnlyKernel<decltype(erf_hpu_wrap), &erf_hpu_wrap>(
                    DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
        ...
        .op(torch::RegisterOperators::options()
                ...
                .impl_unboxedOnlyKernel<decltype(exp_hpu_wrap), &exp_hpu_wrap>(
                    DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
        ...
        .op(torch::RegisterOperators::options()
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &reciprocal_out_hpu_wrap>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
        ...
        .op(torch::RegisterOperators::options()
                ...
                .impl_unboxedOnlyKernel<decltype(abs_hpu_wrap), &abs_hpu_wrap>(
                    DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema("aten::neg(Tensor self) -> Tensor")
                .impl_unboxedOnlyKernel<decltype(neg_hpu_wrap), &neg_hpu_wrap>(
                    DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
        ...
        .op(torch::RegisterOperators::options()
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &matmul_backward_hpu_wrap>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &embedding_bag_sum_hpu_wrap>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
                ...
                .impl_unboxedOnlyKernel<
                    decltype(embedding_bag_sum_bwd_out_kernel_mode_hpu_wrap),
        ...
        .op(torch::RegisterOperators::options()
                ...
                .impl_unboxedOnlyKernel<
                    decltype(optimizer_sparse_sgd_with_valid_count_hpu_wrap),
                    &optimizer_sparse_sgd_with_valid_count_hpu_wrap>(
                    DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema("hpu::habana_d2d_memcpy(Tensor self) -> (Tensor)")
                .impl_unboxedOnlyKernel<
        ...
        .op(torch::RegisterOperators::options()
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &habana_d2d_memcpy_other>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema(
        ...
        .op(torch::RegisterOperators::options()
                ...
                .impl_unboxedOnlyKernel<
                    ...
                    &optimizer_adagrad_hpu_wrap>(DispatchKey::HABANATensorId)
                .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
        .op(torch::RegisterOperators::options()
                .schema("hpu::cast(Tensor self, Tensor(a!) out) -> Tensor(a!)")
                .impl_unboxedOnlyKernel<
