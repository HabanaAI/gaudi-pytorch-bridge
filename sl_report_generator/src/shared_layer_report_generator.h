...
class SharedLayerReportGenerator : public ISharedLayerReportGenerator {
 ...
 private:
  ...
  void register_cast_to_fp8_exception();
  void register_cast_to_fp8_v2_exception();
  void register_cast_to_fp8_v2_scalar_exception();
  void register_cast_to_fp8_v2_scalar_list_exception();
  void register_cast_from_fp8_exception();
  void register_cast_from_fp8_scalar_exception();
  void register_cast_from_fp8_scalar_list_exception();
  ...
  void register_mixture_of_experts_exception();
  void register_mixture_of_experts_fp8_exception();
  void register_mixture_of_experts_fp8_blockwise_exception();
  void register_mixture_of_experts_fp8_dynamic_exception();
  void register_mixture_of_experts_fp8_fused_weights_exception();
  void register_mixture_of_experts_fp8_fused_weights_blockwise_exception();
  void register_mixture_of_experts_fp8_fused_weights_dynamic_exception();
  void register_mixture_of_experts_fp8_fused_weights_scalars_exception();
  void register_mixture_of_experts_fp8_fused_weights_scalars_dynamic_exception();
  void register_mixture_of_experts_fp8_scalars_exception();
  void register_mixture_of_experts_fp8_scalars_dynamic_exception();
  void register_mixture_of_experts_fused_weights_exception();
  ...
  void register_optimizer_sgd_exception();
  void register_optimizer_sgd_momentum_exception();
  void register_ragged_softmax_exception();
  ...
  void register_scaled_masked_triangular_softmax_exception();
  ...
  void register_softmax_fp8_exception();
