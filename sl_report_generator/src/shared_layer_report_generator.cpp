...
void SharedLayerReportGenerator::register_exceptions() {
  ...
  register_cast_to_fp8_exception();
  register_cast_to_fp8_v2_exception();
  register_cast_to_fp8_v2_scalar_exception();
  register_cast_to_fp8_v2_scalar_list_exception();
  register_cast_from_fp8_exception();
  register_cast_from_fp8_scalar_exception();
  register_cast_from_fp8_scalar_list_exception();
  ...
  register_mixture_of_experts_exception();
  register_mixture_of_experts_fp8_exception();
  register_mixture_of_experts_fp8_blockwise_exception();
  register_mixture_of_experts_fp8_dynamic_exception();
  register_mixture_of_experts_fp8_fused_weights_exception();
  register_mixture_of_experts_fp8_fused_weights_blockwise_exception();
  register_mixture_of_experts_fp8_fused_weights_dynamic_exception();
  register_mixture_of_experts_fp8_fused_weights_scalars_exception();
  register_mixture_of_experts_fp8_fused_weights_scalars_dynamic_exception();
  register_mixture_of_experts_fp8_scalars_exception();
  register_mixture_of_experts_fp8_scalars_dynamic_exception();
  register_mixture_of_experts_fused_weights_exception();
  ...
  register_optimizer_sgd_exception();
  register_optimizer_sgd_momentum_exception();
  register_ragged_softmax_exception();
  register_reflection_pad_exception();
  register_replication_pad_exception();
  register_rotary_pos_embedding_exception();
  register_scaled_masked_triangular_softmax_exception();
  ...
  register_softmax_fp8_exception();
...
void SharedLayerReportGenerator::register_cast_to_fp8_exception() {
  custom_stack_generators.push_back(
      std::make_unique<StackGenerator>(StackGenerator(
          {InputDescriptor{/* name */ "input",
           ...
           InputDescriptor{/* name */ "scale",
                           ...
                           /* is_array */ false,
                           /* array_length */ std::nullopt},
           InputDescriptor{/* name */ "stochastic_rounding",
                           ...
                           /* dtypes */ std::nullopt,
                           /* match_precision_type */ false,
                           /* values */ std::vector<std::any>{true, false},
                           /* is_array */ false,
                           /* array_length */ std::nullopt},
           InputDescriptor{
               /* name */ "out",
...
void SharedLayerReportGenerator::register_cast_to_fp8_v2_exception() {
  custom_stack_generators.push_back(
      std::make_unique<StackGenerator>(StackGenerator(
          {InputDescriptor{/* name */ "input",
                           /* type */ InputType::PT_TENSOR,
           ...
           InputDescriptor{
               ...
               /* is_array */ false,
               /* array_length */ std::nullopt},
           InputDescriptor{/* name */ "scale_shape",
                           /* type */ InputType::NATIVE_INT,
                           /* is_optional */ true,
                           /* allow_only_none */ true,
                           /* allow_none */ true,
                           /* ranks */ std::nullopt,
                           /* match_rank */ std::nullopt,
                           /* dtypes */ std::nullopt,
  ...
  custom_executors.push_back(
      std::make_unique<CustomSharedLayerExecutor<>>(
          custom_stack_generators.back().get(),
          &habana::validator_cast_to_fp8_v2));
...
void SharedLayerReportGenerator::register_cast_to_fp8_v2_scalar_exception() {
  custom_stack_generators.push_back(
      std::make_unique<StackGenerator>(StackGenerator(
          {InputDescriptor{/* name */ "input",
                           /* type */ InputType::PT_TENSOR,
          ...
          {at::ScalarType::Float8_e4m3fn, at::ScalarType::Float8_e5m2},
          /* whitelisted_precision_types */ {},
          "cast_to_fp8_v2.scalar")));
  custom_executors.push_back(
      std::make_unique<CustomSharedLayerExecutor<>>(
          custom_stack_generators.back().get(),
          &habana::validator_cast_to_fp8_v2_scalar));

  register_op(
      {/* op_name */ "cast_to_fp8_v2.scalar",
       /* overload */ "",
       /* op_namespace */ "torch.hpu"},
      custom_executors.back().get());
}
...
void SharedLayerReportGenerator::
  ...
  custom_stack_generators.push_back(
      std::make_unique<StackGenerator>(StackGenerator(
          ...
          {at::ScalarType::Float8_e4m3fn, at::ScalarType::Float8_e5m2},
          /* whitelisted_precision_types */ {},
          "cast_to_fp8_v2.scalar_list")));
  custom_executors.push_back(
      std::make_unique<CustomSharedLayerExecutor<>>(
          custom_stack_generators.back().get(),
          &habana::validator_cast_to_fp8_v2_scalar_list));

  register_op(
      {/* op_name */ "cast_to_fp8_v2.scalar_list",
       /* overload */ "",
       /* op_namespace */ "torch.hpu"},
      custom_executors.back().get());
}

void SharedLayerReportGenerator::register_cast_from_fp8_exception() {
  custom_stack_generators.push_back(
      std::make_unique<StackGenerator>(StackGenerator(
          {InputDescriptor{/* name */ "input",
                           /* type */ InputType::PT_TENSOR,
           ...
           InputDescriptor{/* name */ "scale",
                           ...
                           /* is_array */ false,
                           /* array_length */ std::nullopt},
           InputDescriptor{/* name */ "out_dtype",
                           /* type */ InputType::DTYPE,
                           /* is_optional */ false,
                           /* allow_only_none */ std::nullopt,
                           /* allow_none */ std::nullopt,
  ...
  custom_executors.push_back(
      std::make_unique<CustomSharedLayerExecutor<>>(
          custom_stack_generators.back().get(),
          &habana::validator_cast_from_fp8));
...
void SharedLayerReportGenerator::register_cast_from_fp8_scalar_exception() {
  custom_stack_generators.push_back(
      std::make_unique<StackGenerator>(StackGenerator(
          {InputDescriptor{/* name */ "input",
                           /* type */ InputType::PT_TENSOR,
  ...
  custom_executors.push_back(
      std::make_unique<CustomSharedLayerExecutor<>>(
          custom_stack_generators.back().get(),
          &habana::validator_cast_from_fp8_scalar));

  register_op(
      {/* op_name */ "cast_from_fp8.scalar",
       /* overload */ "",
       /* op_namespace */ "torch.hpu"},
      custom_executors.back().get());
}
...
void SharedLayerReportGenerator::
  ...
  custom_stack_generators.push_back(
      std::make_unique<StackGenerator>(StackGenerator(
          ...
          /* blacklisted_precision_types */ {},
          /* whitelisted_precision_types */ {},
          "cast_from_fp8.scalar_list")));
  custom_executors.push_back(
      std::make_unique<CustomSharedLayerExecutor<>>(
          custom_stack_generators.back().get(),
          &habana::validator_cast_from_fp8_scalar_list));

  register_op(
      {/* op_name */ "cast_from_fp8.scalar_list",
       /* overload */ "",
       /* op_namespace */ "torch.hpu"},
      custom_executors.back().get());
}
...
void SharedLayerReportGenerator::register_mixture_of_experts_exception() {
  custom_stack_generators.push_back(
      std::make_unique<StackGenerator>(StackGenerator(
          {InputDescriptor{/* name */ "hidden_states",
                           /* type */ InputType::PT_TENSOR,
                           /* is_optional */ false,
                           /* allow_only_none */ std::nullopt,
                           /* allow_none */ std::nullopt,
                           ...
                           /* is_array */ false,
                           /* array_length */ std::nullopt},
           InputDescriptor{/* name */ "expert_routing_table",
                           /* type */ InputType::PT_TENSOR,
                           /* is_optional */ false,
                           /* allow_only_none */ std::nullopt,
                           /* allow_none */ std::nullopt,
           ...
           InputDescriptor{/* name */ "w3",
                           ...
                           /* is_array */ true,
                           /* array_length */ 1},
           InputDescriptor{/* name */ "permuted_weights",
                           /* type */ InputType::NATIVE_BOOL,
                           /* is_optional */ false,
                           /* allow_only_none */ std::nullopt,
                           /* allow_none */ std::nullopt,
                           ...
                           /* is_array */ false,
                           /* array_length */ std::nullopt},
           InputDescriptor{/* name */ "activation",
                           /* type */ InputType::NATIVE_STRING,
                           /* is_optional */ false,
                           /* allow_only_none */ std::nullopt,
                           /* allow_none */ std::nullopt,
                           /* ranks */ std::nullopt,
                           ...
                           /* is_array */ false,
                           /* array_length */ std::nullopt},
           InputDescriptor{/* name */ "experts_min",
                           /* type */ InputType::NATIVE_INT,
                           /* is_optional */ false,
                           /* allow_only_none */ std::nullopt,
                           /* allow_none */ std::nullopt,
                           ...
                           /* is_array */ false,
                           /* array_length */ std::nullopt},
           InputDescriptor{/* name */ "experts_max",
                           /* type */ InputType::NATIVE_INT,
                           /* is_optional */ false,
                           /* allow_only_none */ std::nullopt,
                           /* allow_none */ std::nullopt,
           ...
           InputDescriptor{/* name */ "recomp",
                           ...
                           /* is_array */ false,
                           /* array_length */ std::nullopt},
           InputDescriptor{/* name */ "chunk_size",
                           /* type */ InputType::NATIVE_INT,
                           /* is_optional */ false,
                           /* allow_only_none */ std::nullopt,
                           /* allow_none */ std::nullopt,
                           ...
                           /* is_array */ false,
                           /* array_length */ std::nullopt},
           InputDescriptor{/* name */ "total_experts",
                           /* type */ InputType::NATIVE_INT,
                           /* is_optional */ false,
                           /* allow_only_none */ std::nullopt,
                           /* allow_none */ std::nullopt,
  ...
  custom_executors.push_back(
      std::make_unique<CustomSharedLayerExecutor<>>(
          custom_stack_generators.back().get(),
          &habana::validator_mixture_of_experts));

  register_op(
      {/* op_name */ "mixture_of_experts",
       /* overload */ "",
       /* op_namespace */ "torch.hpu"},
      custom_executors.back().get());
}

void SharedLayerReportGenerator::register_mixture_of_experts_fp8_exception() {
  custom_stack_generators.push_back(
      std::make_unique<StackGenerator>(StackGenerator(
          {InputDescriptor{/* name */ "hidden_states",
                           /* type */ InputType::PT_TENSOR,
           ...
           InputDescriptor{/* name */ "w3",
                           ...
                           /* is_array */ true,
                           /* array_length */ 1},
           InputDescriptor{/* name */ "d_scale_hidden_states",
                           /* type */ InputType::PT_TENSOR,
                           /* is_optional */ false,
                           /* allow_only_none */ std::nullopt,
                           /* allow_none */ std::nullopt,
                           ...
                           /* is_array */ false,
                           /* array_length */ std::nullopt},
           InputDescriptor{/* name */ "d_scale_intermediate_hidden_states",
                           /* type */ InputType::PT_TENSOR,
                           /* is_optional */ false,
                           /* allow_only_none */ std::nullopt,
                           /* allow_none */ std::nullopt,
                           ...
                           /* is_array */ true,
                           /* array_length */ 1},
           InputDescriptor{/* name */ "d_scale_w1",
                           /* type */ InputType::PT_TENSOR,
                           /* is_optional */ false,
                           /* allow_only_none */ std::nullopt,
                           /* allow_none */ std::nullopt,
                           ...
                           /* is_array */ true,
                           /* array_length */ 1},
           InputDescriptor{/* name */ "d_scale_w2",
                           /* type */ InputType::PT_TENSOR,
                           /* is_optional */ false,
                           /* allow_only_none */ std::nullopt,
                           /* allow_none */ std::nullopt,
                           ...
                           /* is_array */ true,
                           /* array_length */ 1},
           InputDescriptor{/* name */ "d_scale_w3",
                           /* type */ InputType::PT_TENSOR,
                           /* is_optional */ false,
                           /* allow_only_none */ std::nullopt,
                           /* allow_none */ std::nullopt,
  ...
  custom_executors.push_back(
      std::make_unique<CustomSharedLayerExecutor<>>(
          custom_stack_generators.back().get(),
          &habana::validator_mixture_of_experts_fp8));

  register_op(
      {/* op_name */ "mixture_of_experts.fp8",
       /* overload */ "",
       /* op_namespace */ "torch.hpu"},
      custom_executors.back().get());
}
...
void SharedLayerReportGenerator::
      ...
      std::make_unique<StackGenerator>(StackGenerator(
          {InputDescriptor{/* name */ "hidden_states",
           ...
           InputDescriptor{/* name */ "d_scale_w3",
                           ...
                           /* is_array */ true,
                           /* array_length */ 1},
           InputDescriptor{/* name */ "block_size",
                           /* type */ InputType::NATIVE_INT,
                           /* is_optional */ false,
                           /* allow_only_none */ std::nullopt,
                           /* allow_none */ std::nullopt,
  ...
  custom_executors.push_back(
      std::make_unique<CustomSharedLayerExecutor<>>(
          custom_stack_generators.back().get(),
          &habana::validator_mixture_of_experts_fp8_blockwise));

  register_op(
      {/* op_name */ "mixture_of_experts.fp8_blockwise",
       /* overload */ "",
       /* op_namespace */ "torch.hpu"},
      custom_executors.back().get());
}
...
void SharedLayerReportGenerator::
  ...
  custom_executors.push_back(
      std::make_unique<CustomSharedLayerExecutor<>>(
          custom_stack_generators.back().get(),
          &habana::validator_mixture_of_experts_fp8_dynamic));

  register_op(
      {/* op_name */ "mixture_of_experts.fp8_dynamic",
       /* overload */ "",
       /* op_namespace */ "torch.hpu"},
      custom_executors.back().get());
}
...
void SharedLayerReportGenerator::
      ...
      std::make_unique<StackGenerator>(StackGenerator(
          {InputDescriptor{/* name */ "hidden_states",
           ...
           InputDescriptor{/* name */ "d_scale_intermediate_hidden_states",
                           ...
                           /* is_array */ true,
                           /* array_length */ 1},
           InputDescriptor{/* name */ "d_scale_w12",
                           /* type */ InputType::PT_TENSOR,
                           /* is_optional */ false,
                           /* allow_only_none */ std::nullopt,
                           /* allow_none */ std::nullopt,
  ...
  custom_executors.push_back(
      std::make_unique<CustomSharedLayerExecutor<>>(
          custom_stack_generators.back().get(),
          &habana::validator_mixture_of_experts_fp8_fused_weights));

  register_op(
      {/* op_name */ "mixture_of_experts.fp8_fused_weights",
       /* overload */ "",
       /* op_namespace */ "torch.hpu"},
      custom_executors.back().get());
}
...
void SharedLayerReportGenerator::
  ...
  custom_executors.push_back(
      std::make_unique<CustomSharedLayerExecutor<>>(
          custom_stack_generators.back().get(),
          &habana::validator_mixture_of_experts_fp8_fused_weights_blockwise));

  register_op(
      {/* op_name */ "mixture_of_experts.fp8_fused_weights_blockwise",
       /* overload */ "",
       /* op_namespace */ "torch.hpu"},
      custom_executors.back().get());
}
...
void SharedLayerReportGenerator::
  ...
  custom_executors.push_back(
      std::make_unique<CustomSharedLayerExecutor<>>(
          custom_stack_generators.back().get(),
          &habana::validator_mixture_of_experts_fp8_fused_weights_dynamic));

  register_op(
      {/* op_name */ "mixture_of_experts.fp8_fused_weights_dynamic",
       /* overload */ "",
       /* op_namespace */ "torch.hpu"},
      custom_executors.back().get());
}
...
void SharedLayerReportGenerator::
  ...
  custom_executors.push_back(
      std::make_unique<CustomSharedLayerExecutor<>>(
          custom_stack_generators.back().get(),
          &habana::validator_mixture_of_experts_fp8_fused_weights_scalars));

  register_op(
      {/* op_name */ "mixture_of_experts.fp8_fused_weights_scalars",
       /* overload */ "",
       /* op_namespace */ "torch.hpu"},
      custom_executors.back().get());
}
...
void SharedLayerReportGenerator::
  ...
  custom_stack_generators.push_back(
      std::make_unique<StackGenerator>(StackGenerator(
          ...
          {at::ScalarType::Float, at::ScalarType::BFloat16},
          /* whitelisted_precision_types */ {},
          "mixture_of_experts.fp8_fused_weights_scalars_dynamic")));
  custom_executors.push_back(
      std::make_unique<CustomSharedLayerExecutor<>>(
          custom_stack_generators.back().get(),
          &habana::
              validator_mixture_of_experts_fp8_fused_weights_scalars_dynamic));

  register_op(
      {/* op_name */ "mixture_of_experts.fp8_fused_weights_scalars_dynamic",
       /* overload */ "",
       /* op_namespace */ "torch.hpu"},
      custom_executors.back().get());
}
...
void SharedLayerReportGenerator::
  ...
  custom_executors.push_back(
      std::make_unique<CustomSharedLayerExecutor<>>(
          custom_stack_generators.back().get(),
          &habana::validator_mixture_of_experts_fp8_scalars));

  register_op(
      {/* op_name */ "mixture_of_experts.fp8_scalars",
       /* overload */ "",
       /* op_namespace */ "torch.hpu"},
      custom_executors.back().get());
}
...
void SharedLayerReportGenerator::
  ...
  custom_stack_generators.push_back(
      std::make_unique<StackGenerator>(StackGenerator(
          ...
          {at::ScalarType::Float, at::ScalarType::BFloat16},
          /* whitelisted_precision_types */ {},
          "mixture_of_experts.fp8_scalars_dynamic")));
  custom_executors.push_back(
      std::make_unique<CustomSharedLayerExecutor<>>(
          custom_stack_generators.back().get(),
          &habana::validator_mixture_of_experts_fp8_scalars_dynamic));

  register_op(
      {/* op_name */ "mixture_of_experts.fp8_scalars_dynamic",
       /* overload */ "",
       /* op_namespace */ "torch.hpu"},
      custom_executors.back().get());
}
...
void SharedLayerReportGenerator::
  ...
  custom_executors.push_back(
      std::make_unique<CustomSharedLayerExecutor<>>(
          custom_stack_generators.back().get(),
          &habana::validator_mixture_of_experts_fused_weights));

  register_op(
      {/* op_name */ "mixture_of_experts.fused_weights",
       /* overload */ "",
       /* op_namespace */ "torch.hpu"},
      custom_executors.back().get());
}
...
void SharedLayerReportGenerator::register_optimizer_sgd_exception() {
  custom_stack_generators.push_back(
      std::make_unique<StackGenerator>(StackGenerator(
          {
              InputDescriptor{/* name */ "gradients",
                              /* type */ InputType::PT_TENSOR,
                              /* is_optional */ false,
                              /* allow_only_none */ std::nullopt,
                              /* allow_none */ std::nullopt,
              ...
              InputDescriptor{
                  ...
                  /* match_rank */ true,
                  /* dtypes */
                  std::vector<at::ScalarType>{at::ScalarType::Float},
                  /* match_precision_type */ false,
                  /* values */ std::nullopt,
                  /* is_array */ true,
                  /* array_length */ 2},
              ...
              InputDescriptor{/* name */ "nesterov",
                              ...
                              /* dtypes */ std::nullopt,
                              /* match_precision_type */ std::nullopt,
                              /* values */ std::vector<std::any>{true},
                              /* is_array */ false,
                              /* array_length */ std::nullopt},
          },
          /* blacklisted_precision_types */
  ...
  custom_executors.push_back(
      std::make_unique<CustomSharedLayerExecutor<>>(
          custom_stack_generators.back().get(),
          &habana::validator_optimizer_sgd));

  register_op(
      {/* op_name */ "optimizer_sgd",
       /* overload */ "",
       /* op_namespace */ "torch.hpu.optimizer"},
      custom_executors.back().get());
}

void SharedLayerReportGenerator::register_optimizer_sgd_momentum_exception() {
  custom_stack_generators.push_back(
      std::make_unique<StackGenerator>(StackGenerator(
          {
              InputDescriptor{/* name */ "gradients",
              ...
              InputDescriptor{
                  ...
                  /* ranks */ std::nullopt,
                  /* match_rank */ true,
                  /* dtypes */ std::vector<at::ScalarType>{at::ScalarType::Int},
                  /* match_precision_type */ false,
                  /* values */ std::nullopt,
                  /* is_array */ false,
                  /* array_length */ std::nullopt},
  ...
  custom_executors.push_back(
      std::make_unique<CustomSharedLayerExecutor<>>(
          custom_stack_generators.back().get(),
          &habana::validator_optimizer_sgd_momentum));

  register_op(
      {/* op_name */ "optimizer_sgd_momentum",
       /* overload */ "",
       /* op_namespace */ "torch.hpu.optimizer"},
      custom_executors.back().get());
}

void SharedLayerReportGenerator::register_ragged_softmax_exception() {
  custom_stack_generators.push_back(
      std::make_unique<StackGenerator>(StackGenerator(
          {InputDescriptor{/* name */ "self",
                           /* type */ InputType::PT_TENSOR,
           ...
           InputDescriptor{/* name */ "dim",
                           ...
                           /* is_array */ false,
                           /* array_length */ std::nullopt},
           InputDescriptor{/* name */ "half_to_float",
                           /* type */ InputType::NATIVE_BOOL,
                           /* is_optional */ false,
                           /* allow_only_none */ std::nullopt,
                           /* allow_none */ std::nullopt,
  ...
  custom_executors.push_back(
      std::make_unique<GenericSharedLayerExecutor<>>(
          custom_stack_generators.back().get(),
          &habana::validator_ragged_softmax));

  register_op(
      {/* op_name */ "ragged_softmax",
       /* overload */ "",
       /* op_namespace */ "torch.hpu"},
      custom_executors.back().get());
}
...
// custom_op_schema: "hpu::scaled_masked_triangular_softmax(Tensor self, Tensor
// start_end, float inv_scale_attn, int grouped_batch_size, bool use_max, int
// mode, ScalarType? out_dtype=None) -> Tensor"
void SharedLayerReportGenerator::
    register_scaled_masked_triangular_softmax_exception() {
  custom_stack_generators.push_back(
      std::make_unique<StackGenerator>(StackGenerator(
          {InputDescriptor{/* name */ "self",
           ...
           InputDescriptor{
               ...
               /* is_array */ false,
               /* array_length */ std::nullopt},
           InputDescriptor{/* name */ "inv_scale_attn",
                           /* type */ InputType::NATIVE_FLOAT,
                           /* is_optional */ false,
                           /* allow_only_none */ std::nullopt,
                           /* allow_none */ std::nullopt,
                           ...
                           /* is_array */ false,
                           /* array_length */ std::nullopt},
           InputDescriptor{/* name */ "grouped_batch_size",
                           /* type */ InputType::NATIVE_INT,
                           /* is_optional */ false,
                           /* allow_only_none */ std::nullopt,
                           /* allow_none */ std::nullopt,
  ...
  custom_executors.push_back(
      std::make_unique<CustomSharedLayerExecutor<>>(
          custom_stack_generators.back().get(),
          &habana::validator_scaled_masked_triangular_softmax));
...
void SharedLayerReportGenerator::register_softmax_fp8_exception() {
  custom_stack_generators.push_back(
      std::make_unique<StackGenerator>(StackGenerator(
          {InputDescriptor{/* name */ "input",
                           /* type */ InputType::PT_TENSOR,
           ...
           InputDescriptor{/* name */ "dim",
                           ...
                           /* is_array */ false,
                           /* array_length */ std::nullopt},
           InputDescriptor{/* name */ "input_scale",
                           /* type */ InputType::PT_TENSOR,
                           /* is_optional */ true,
                           /* allow_only_none */ std::nullopt,
                           /* allow_none */ false,
                           ...
                           /* is_array */ false,
                           /* array_length */ std::nullopt},
           InputDescriptor{/* name */ "output_scale",
                           /* type */ InputType::PT_TENSOR,
                           /* is_optional */ true,
                           /* allow_only_none */ std::nullopt,
                           /* allow_none */ false,
                           ...
                           /* is_array */ false,
                           /* array_length */ std::nullopt},
           InputDescriptor{/* name */ "inv_attn_heads",
                           /* type */ InputType::PT_TENSOR,
                           /* is_optional */ true,
                           /* allow_only_none */ std::nullopt,
                           /* allow_none */ false,
                           ...
                           /* is_array */ false,
                           /* array_length */ std::nullopt},
           InputDescriptor{/* name */ "fused_add",
                           /* type */ InputType::PT_TENSOR,
                           /* is_optional */ true,
                           /* allow_only_none */ std::nullopt,
                           /* allow_none */ false,
          ...
          /* whitelisted_precision_types */ {at::ScalarType::Float8_e5m2},
          "softmax_fp8")));
  custom_executors.push_back(
      std::make_unique<CustomSharedLayerExecutor<>>(
          custom_stack_generators.back().get(),
          &habana::validator_softmax_fp8));
  ...
  custom_executors.push_back(
      std::make_unique<CustomSharedLayerExecutor<>>(
          custom_stack_generators.back().get(),
          &habana::validator_softmax_fp8_Scalar_scales));

  register_op(
      {/* op_name */ "softmax_fp8.Scalar_scales",
       /* overload */ "",
       /* op_namespace */ "torch.hpu"},
      custom_executors.back().get());
  ...
  custom_executors.push_back(
      std::make_unique<CustomSharedLayerExecutor<>>(
          custom_stack_generators.back().get(),
          &habana::validator_softmax_fp8_Scalar));

  register_op(
      {/* op_name */ "softmax_fp8.Scalar",
       /* overload */ "",
       /* op_namespace */ "torch.hpu"},
      custom_executors.back().get());
}
...
void SharedLayerReportGenerator::register_static_exceptions() {
  ...
  custom_executors.push_back(
      std::make_unique<StaticSharedLayerExecutor<>>(
          std::vector<c10::ScalarType>{
              ...
              c10::ScalarType::Float8_e4m3fn,
              c10::ScalarType::Float8_e5m2}));
  auto fpExecutor = custom_executors.back().get();
  ...
  custom_executors.push_back(
      std::make_unique<StaticSharedLayerExecutor<>>(
          Report(/* fp4 */ true, /* int4 */ false)));
  auto fp4Executor = custom_executors.back().get();

  custom_executors.push_back(
      std::make_unique<StaticSharedLayerExecutor<>>(
          std::vector<c10::ScalarType>{
              c10::ScalarType::Float8_e4m3fn, c10::ScalarType::Float8_e5m2}));
  auto fp8Executor = custom_executors.back().get();
  ...
  register_op(
      {/* op_name */ "block_softmax_adjustment",
       /* overload */ "",
       /* op_namespace */ "torch.hpu"},
      fpExceptFp8Executor);
  ...
  /* FP8_SDPA */
  register_op(
      {/* op_name */ "fp8_sdpa_fwd",
       /* overload */ "",
       /* op_namespace */ "torch.hpu"},
      fp8Executor);
  register_op(
      {/* op_name */ "fp8_sdpa_fwd_non_dropout",
       /* overload */ "",
       /* op_namespace */ "torch.hpu"},
      fp8Executor);
  register_op(
      {/* op_name */ "fp8_sdpa_fwd_dropout",
       /* overload */ "",
       /* op_namespace */ "torch.hpu"},
      fp8Executor);
  register_op(
      {/* op_name */ "fp8_sdpa_bwd",
       /* overload */ "",
       /* op_namespace */ "torch.hpu"},
      fp8Executor);
  register_op(
      {/* op_name */ "fp8_sdpa_recomp_fwd",
       /* overload */ "",
       /* op_namespace */ "torch.hpu"},
      fp8Executor);
  register_op(
      {/* op_name */ "fp8_sdpa_recomp_fwd_non_dropout",
       /* overload */ "",
       /* op_namespace */ "torch.hpu"},
      fp8Executor);
  register_op(
      {/* op_name */ "fp8_sdpa_recomp_fwd_dropout ",
       /* overload */ "",
       /* op_namespace */ "torch.hpu"},
      fp8Executor);
  ...
  /* SPDA*/
  register_op(
      {/* op_name */ "sdpa_recomp_fwd_non_dropout",
       /* overload */ "",
       /* op_namespace */ "torch.hpu"},
      fpExceptFp8Executor);
  register_op(
      {/* op_name */ "sdpa_recomp_fwd",
       /* overload */ "",
       /* op_namespace */ "torch.hpu"},
      fpExceptFp8Executor);
  register_op(
      {/* op_name */ "sdpa_recomp_bwd",
       /* overload */ "",
       /* op_namespace */ "torch.hpu"},
      fpExceptFp8Executor);
  register_op(
  ...
  register_op(
      ...
      fpExceptFp8Executor);
  register_op(
      {/* op_name */ "sdpa_fwd_non_dropout",
       /* overload */ "",
       /* op_namespace */ "torch.hpu"},
      fpExceptFp8Executor);
  register_op(
      {/* op_name */ "sdpa_fwd_dropout",
       /* overload */ "",
       /* op_namespace */ "torch.hpu"},
      fpExceptFp8Executor);
