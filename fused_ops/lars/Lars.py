            ...
            for group in self.optim.param_groups:
                ...
                for idx, p in enumerate(group['params']):
                    ...
                    if self.skip_mask[idx] == 1:
                        ...
                        trust_ratio = torch.where(torch.greater(param_norm, 0),
                                torch.where(torch.greater(grad_norm, 0),
                                    (self.eeta * param_norm /
                                    (grad_norm + weight_decay * param_norm + self.eps)), 1.0), 1.0)
