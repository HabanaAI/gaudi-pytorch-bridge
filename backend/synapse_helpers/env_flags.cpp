...
ENV_STRUCT_STATIC_DEFINITION(PT_ENABLE_COMM_GROUP_CACHE, bool);
...
ENV_STRUCT_STATIC_DEFINITION(PT_PROFILE_SYNAPSE_LOGS, bool);
ENV_STRUCT_STATIC_DEFINITION(PT_PROFILE_BRIDGE_LOGS, bool);
ENV_STRUCT_STATIC_DEFINITION(PT_PROFILE_MEMORY, bool);
