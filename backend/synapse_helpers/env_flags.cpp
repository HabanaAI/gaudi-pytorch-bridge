...
ENV_STRING_STRUCT_STATIC_DEFINITION(PT_HPU_RECIPE_CACHE_CONFIG);

ENV_STRUCT_STATIC_DEFINITION(PT_HPU_CLUSTERED_PROGRAM, bool);
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_CLUSTERED_PROGRAM_ENFORCE, bool);
ENV_STRING_STRUCT_STATIC_DEFINITION(PT_HPU_CLUSTERED_PROGRAM_SPLIT_STR);
ENV_STRING_STRUCT_STATIC_DEFINITION(PT_HPU_CLUSTERED_PROGRAM_SCHED_STR);
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_LAZY_MODE, unsigned);
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_LAZY_ACC_PAR_MODE, unsigned);
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_LAZY_ACC_VIEW_OPS_MODE, unsigned);
...
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_EAGER_SHAPE_AGNOSTIC_GRAPH, bool);
...
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_ENABLE_HPUGRAPH_THREAD, bool);
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_ENABLE_D2H_ASYNC_THREAD, bool);
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_QUEUE_SYNLAUNCHES, bool);
...
ENV_STRUCT_STATIC_DEFINITION(
    ...
    bool);
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_INFERENCE_STORAGE_OVERRIDE, bool);
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_ENABLE_LAZY_EAGER_EXECUTION_THREAD, bool);
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_ENABLE_LAZY_EAGER_LAUNCH_EXEC_THREAD, bool);
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_ENABLE_EAGER_COMPILE_EXEC_THREAD, bool);
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_ENABLE_EXECUTION_THREAD_NO_WAIT, bool);
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_THREAD_POOL_QUEUE_CAPACITY, unsigned long);
ENV_STRUCT_STATIC_DEFINITION(PT_ENABLE_INTER_HOST_CACHING, bool);
ENV_STRUCT_STATIC_DEFINITION(PT_DO_NOT_LOWER_LINEAR_OP, bool);
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_ENABLE_CACHE_METRICS, bool);
...
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_EAGER_VIEW_HANDLING, bool);
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_EAGER_PIPELINE_ENABLE, bool);
...
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_POOL_MEM_FRAGMENT_JSON, bool);
ENV_STRUCT_STATIC_DEFINITION(PT_ENABLE_REALTIME_MEMORY_LOGGING, bool);
ENV_STRUCT_STATIC_DEFINITION(PT_ENABLE_LIGHTWEIGHT_MEMORY_USAGE_LOGGING, bool);
...
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_STAGE_SUBMISSION_MODE, unsigned);
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_PGM_ENABLE_CACHE, bool);
ENV_STRUCT_STATIC_DEFINITION(PT_FORCED_TRACING_MASK, unsigned long);
...
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_POOL_MEM_ALLOC_ENABLE_RETRY, bool);
ENV_STRUCT_STATIC_DEFINITION(PT_ENABLE_WORKSPACE_MEMORY_SHRINK, bool);
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_POOL_MEM_ACQUIRE_PERC, unsigned);
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_ENABLE_EAGER_COMPILER, bool);
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_ENABLE_EAGER_CACHE, bool);
...
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_ENABLE_SFG, bool);
ENV_STRUCT_STATIC_DEFINITION(PT_SBS, unsigned);
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_FORCE_INDEX_PUT_FRONTEND_FALLBACK, bool);
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_EAGER_INDEX_PUT_BOOL_OPTIMIZED, bool);
...
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_FORCE_TANH_FOR_GELU, bool);
...
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_ENABLE_WEIGHT_HPU_PERMUTE, bool);
...
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_ENABLE_NMS_USING_BNMS_CGUID, bool);
...
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_ENABLE_GRADIENT_VIEW_LAYOUT_OPT, bool);
ENV_STRUCT_STATIC_DEFINITION(
    PT_HPU_EAGER_ENABLE_GRADIENT_VIEW_LAYOUT_OPT,
    bool);
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_MATMUL3D_2D_RESHAPE, bool);
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_ENABLE_GRAPH_RUNNING_HASH, bool);
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_ENABLE_VALIDATE_GRAPH_RUNNING_HASH, bool);
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_SYNCHRONOUS_ACC_QUEUE_FLUSHING, bool);
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_ACC_THREAD_VERSION, int);
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_USE_BN_FWD_IN_GN_BWD, bool);
ENV_STRUCT_STATIC_DEFINITION(PT_ENABLE_INT64_SUPPORT, bool);
ENV_STRUCT_STATIC_DEFINITION(PT_DISABLE_DTYPE_PROMOTION, bool);
ENV_STRUCT_STATIC_DEFINITION(PT_WAIT_FOR_ALL_FUTURES_IN_CLEANUP, bool);
ENV_STRUCT_STATIC_DEFINITION(PT_TB_ENABLE_FLOW_EVENTS, bool);
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_USE_UNSORTED_SCATTER_ADD, bool);
ENV_STRUCT_STATIC_DEFINITION(PT_USE_FP8_143, bool);
...
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_ENABLE_JIT_GRAPH_NAME_HASH, bool);
...
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_DEV_ENABLE_REPEAT_HOST_TENSOR, bool);
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_DEV_ENABLE_PAD_HOST_TENSOR, bool);
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_DEV_ENABLE_TOPK_USING_CGUID, bool);
...
ENV_STRUCT_STATIC_DEFINITION(
    ...
    unsigned);
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_ENABLE_H2D_DYNAMIC_AS_STRIDED, bool);
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_ENABLE_H2D_DYNAMIC_SLICE, bool);
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_ENABLE_UNIQUE_GRAPH, bool);
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_ENABLE_BROADCAST_BUCKET_HANDLING, bool);
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_ENABLE_COMPOUND_LOWERING_OPS, bool);

// Stream
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_ENABLE_GENERIC_STREAM, bool);
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_ENABLE_RECORD_STREAM, bool);
ENV_STRUCT_STATIC_DEFINITION(PT_HPU_USE_LAUNCH_RECORD_STREAM, bool);
// 2.0 support
