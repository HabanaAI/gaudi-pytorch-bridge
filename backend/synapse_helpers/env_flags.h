...
ENV_STRUCT_DEFINITION(PT_HPU_ENABLE_DETERMINISTIC_MODE, bool, false);
...
ENV_STRUCT_DEFINITION(PT_HPU_LAZY_EAGER_SHAPE_AGNOSTIC_GRAPH, bool, false);
...
ENV_STRUCT_DEFINITION(PT_HPU_ENABLE_REFINE_DYNAMIC_SHAPES, bool, true);
