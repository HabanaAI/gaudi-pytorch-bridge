...
ENV_STRING_STRUCT_DEFINITION(PT_HPU_CLUSTERED_PROGRAM_SCHED_STR, "default");
ENV_STRUCT_DEFINITION(PT_HPU_LAZY_MODE, unsigned, 1);
ENV_STRUCT_DEFINITION(PT_HPU_LAZY_ACC_PAR_MODE, unsigned, 1);
ENV_STRUCT_DEFINITION(PT_HPU_LAZY_ACC_VIEW_OPS_MODE, unsigned, 0);
...
ENV_STRUCT_DEFINITION(PT_HPU_EAGER_SHAPE_AGNOSTIC_GRAPH, bool, true);
ENV_STRUCT_DEFINITION(PT_HPU_LAZY_EAGER_VIEW_HANDLING, bool, false);
ENV_STRUCT_DEFINITION(PT_HPU_ENABLE_CACHE_METRICS, bool, false);
...
ENV_STRUCT_DEFINITION(PT_HPU_ENABLE_HPUGRAPH_THREAD, bool, true);
ENV_STRUCT_DEFINITION(PT_HPU_ENABLE_D2H_ASYNC_THREAD, bool, true);
ENV_STRUCT_DEFINITION(PT_HPU_QUEUE_SYNLAUNCHES, bool, true);
ENV_STRUCT_DEFINITION(PT_HPU_INFERENCE_MODE, bool, false);
ENV_STRUCT_DEFINITION(
    PT_HPU_INFERENCE_SYNAPSE_DATA_TYPE_SELECTION,
    bool,
    false);
ENV_STRUCT_DEFINITION(PT_HPU_INFERENCE_STORAGE_OVERRIDE, bool, true);
ENV_STRUCT_DEFINITION(PT_HPU_ENABLE_LAZY_EAGER_EXECUTION_THREAD, bool, true);
ENV_STRUCT_DEFINITION(PT_HPU_ENABLE_LAZY_EAGER_LAUNCH_EXEC_THREAD, bool, false);
ENV_STRUCT_DEFINITION(PT_HPU_ENABLE_EAGER_COMPILE_EXEC_THREAD, bool, false);
ENV_STRUCT_DEFINITION(PT_HPU_ENABLE_EXECUTION_THREAD_NO_WAIT, bool, false);
ENV_STRUCT_DEFINITION(PT_HPU_THREAD_POOL_QUEUE_CAPACITY, unsigned long, 200000);
ENV_STRUCT_DEFINITION(PT_ENABLE_INTER_HOST_CACHING, bool, false);
ENV_STRUCT_DEFINITION(PT_DO_NOT_LOWER_LINEAR_OP, bool, false);
...
ENV_STRUCT_DEFINITION(PT_HPU_EAGER_VIEW_HANDLING, bool, true);
ENV_STRUCT_DEFINITION(PT_HPU_EAGER_PIPELINE_ENABLE, bool, true);
ENV_STRUCT_DEFINITION(
...
ENV_STRUCT_DEFINITION(PT_HPU_ENABLE_SLICE_INSERT, bool, true);
ENV_STRUCT_DEFINITION(PT_HPU_PRINT_BACKTRACE_ON_SIGNAL, bool, false);
...
ENV_STRUCT_DEFINITION(PT_HPU_AVOID_RE_EXECUTE_GRAPHS, bool, false);
...
ENV_STRUCT_DEFINITION(PT_HPU_STAGE_SUBMISSION_MODE, unsigned, 0b10);
// flag to control recipe caching in non-eager backend
ENV_STRUCT_DEFINITION(PT_HPU_PGM_ENABLE_CACHE, bool, true);
ENV_STRUCT_DEFINITION(PT_FORCED_TRACING_MASK, unsigned long, 0);
ENV_STRUCT_DEFINITION(PT_HPU_ENABLE_EAGER_COMPILER, bool, true);
// separate flag to control recipe caching in eager backend
ENV_STRUCT_DEFINITION(PT_HPU_ENABLE_EAGER_CACHE, bool, false);
...
ENV_STRUCT_DEFINITION(PT_HPU_ENABLE_SFG, bool, false);
ENV_STRUCT_DEFINITION(PT_SBS, unsigned, 0);
ENV_STRUCT_DEFINITION(PT_HPU_FORCE_TANH_FOR_GELU, bool, true);
ENV_STRUCT_DEFINITION(PT_HPU_FORCE_INDEX_PUT_FRONTEND_FALLBACK, bool, false);
ENV_STRUCT_DEFINITION(PT_HPU_EAGER_INDEX_PUT_BOOL_OPTIMIZED, bool, true);
ENV_STRUCT_DEFINITION(PT_HPU_VISUALIZE_GRAPH_INDEX, bool, false);
ENV_STRUCT_DEFINITION(PT_HPU_ENABLE_NMS_USING_BNMS_CGUID, bool, true);
...
ENV_STRUCT_DEFINITION(PT_HPU_ENABLE_JIT_GRAPH_NAME_HASH, bool, false);
...
ENV_STRUCT_DEFINITION(PT_HPU_DEV_ENABLE_REPEAT_HOST_TENSOR, bool, true);
ENV_STRUCT_DEFINITION(PT_HPU_DEV_ENABLE_PAD_HOST_TENSOR, bool, true);
ENV_STRUCT_DEFINITION(PT_HPU_DEV_ENABLE_TOPK_USING_CGUID, bool, true);
ENV_STRING_STRUCT_DEFINITION(PT_HPU_DYNAMIC_MIN_POLICY_ORDER, "4,5,3,1");
ENV_STRING_STRUCT_DEFINITION(PT_HPU_DYNAMIC_MAX_POLICY_ORDER, "2,4,5,3,1");
ENV_STRUCT_DEFINITION(PT_HPU_VALIDATE_COMPUTE_SHAPE, bool, false);
ENV_STRUCT_DEFINITION(PT_HPU_ENABLE_ZERO_MIN, bool, false);
ENV_STRUCT_DEFINITION(PT_HPU_ENABLE_DISK_CACHE_FOR_DSD, bool, false);
ENV_STRUCT_DEFINITION(PT_HPU_DS_TIME_IMPROVE_THRESHOLD_PERCENT, unsigned, 10);
// Option to enable Fast shape Inference
ENV_STRUCT_DEFINITION(PT_HPU_ENABLE_FAST_SHAPE_INFERENCE, bool, true);
// Option to enable and run Hybrid shape Inference
ENV_STRUCT_DEFINITION(PT_HPU_RUN_HYBRID_SIF, bool, true);
...
ENV_STRUCT_DEFINITION(PT_HPU_ENABLE_H2D_DYNAMIC_SLICE, bool, true);
...
ENV_STRUCT_DEFINITION(PT_HPU_POOL_STRATEGY, unsigned, 4);
...
ENV_STRUCT_DEFINITION(PT_ENABLE_WORKSPACE_MEMORY_SHRINK, bool, true);
ENV_STRUCT_DEFINITION(PT_HPU_POOL_MEM_FRAGMENT_JSON, bool, false);
ENV_STRUCT_DEFINITION(PT_ENABLE_REALTIME_MEMORY_LOGGING, bool, false);
ENV_STRUCT_DEFINITION(PT_ENABLE_LIGHTWEIGHT_MEMORY_USAGE_LOGGING, bool, false);
// G1: 4 buffers, 6 communicators, internal slicing at 16 MB (16*4*6=384) per
// stream
ENV_STRUCT_DEFINITION(PT_HCCL_MEMORY_ALLOWANCE_MB, unsigned, 0);
ENV_STRUCT_DEFINITION(PT_ENABLE_MEMORY_DEFRAGMENTATION, bool, true);
...
ENV_STRUCT_DEFINITION(PT_HPU_POOL_MEM_ACQUIRE_PERC, unsigned, 100);
ENV_STRUCT_DEFINITION(PT_HPU_POOL_MEM_ALLOC_ENABLE_RETRY, bool, false);
...
ENV_STRUCT_DEFINITION(PT_HPU_ENABLE_WEIGHT_HPU_PERMUTE, bool, false);
...
ENV_STRUCT_DEFINITION(PT_HPU_SYNCHRONOUS_ACC_QUEUE_FLUSHING, bool, false);
...
// streams
ENV_STRUCT_DEFINITION(PT_HPU_ENABLE_GENERIC_STREAM, bool, true);
ENV_STRUCT_DEFINITION(PT_HPU_ENABLE_RECORD_STREAM, bool, false);
ENV_STRUCT_DEFINITION(PT_HPU_USE_LAUNCH_RECORD_STREAM, bool, false);
// 2.0 support
