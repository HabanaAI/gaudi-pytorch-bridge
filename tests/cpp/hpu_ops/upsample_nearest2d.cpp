...
// Out Variant failing - zero's gets appended
...
//
//   torch::upsample_nearest2d_outf(GetCpuInput(0).to(c10::MemoryFormat::ChannelsLast),
//   size, {}, {}, expected);
//   torch::upsample_nearest2d_outf(GetHpuInput(0).to(c10::MemoryFormat::ChannelsLast),
//   size, {}, {}, result);
//
//   Compare(expected, result);
// }
...
// Out variant failed - zeros appended
...
//      GetCpuInput(0).to(c10::MemoryFormat::ChannelsLast), out_size,
//      input_size, c10::nullopt, c10::nullopt, expected);
//  torch::upsample_nearest2d_backward_outf(
//      GetHpuInput(0).to(c10::MemoryFormat::ChannelsLast), out_size,
//      input_size, c10::nullopt, c10::nullopt, result);
//  Compare(expected, result);
// }