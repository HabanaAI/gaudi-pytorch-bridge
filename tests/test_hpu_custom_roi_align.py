...
def _test_roi_align(num_boxes1, num_boxes2, bs, ch, h, w, sr):
    torch.manual_seed(0)
...
if __name__ == "__main__":
    ...
    _test_roi_align_bwd(4, 2, 2, 8, 100, 100, 2)
    _test_roi_align_bwd(6, 4, 2, 8, 140, 140, 2)
    _test_roi_align_bwd(7, 5, 2, 8, 180, 180, 2)
