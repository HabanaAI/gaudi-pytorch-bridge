...
def _hpu_lazy_slice(dev,t):
    t1 = t.to(dev, non_blocking=False)
    slice_val = [[slice(0, 1, None), slice(None, None, None), slice(0, 128, None), slice(0, 128, None), slice(0, 128, None)],
        [slice(0, 1, None), slice(None, None, None), slice(0, 128, None), slice(0, 128, None), slice(8, 136, None)]]
...
if __name__ == '__main__':
    ...
    test_hpu_lazy_pad_slice(*test_case_list[0])
