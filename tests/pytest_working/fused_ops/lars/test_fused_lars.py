...
def test_lars():
    ...
    model_ref.parameters(), lr=cfg_lr, momentum=cfg_momentum, weight_decay=cfg_weight_decay)

    momentum_optimizer_test = FusedResourceApplyMomentum
    optimizer_ram_test = momentum_optimizer_test(
    model_test.parameters(), lr=cfg_lr, momentum=cfg_momentum, weight_decay=cfg_weight_decay)
