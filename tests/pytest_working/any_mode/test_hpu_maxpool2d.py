...
@pytest.mark.parametrize("shapes", [[(0, 2, 9, 8), (0, 3, 3, 16), (0, 7, 3, 56)]])
...
def test_hpu_maxpool2d_bwd(shapes, kernel_size, stride, padding, dilation, return_indices, ceil_mode, setup_teardown_env_fixture):
