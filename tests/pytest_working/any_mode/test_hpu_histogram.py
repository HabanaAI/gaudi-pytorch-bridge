...
@pytest.mark.parametrize("input_size", param_input_size)
@pytest.mark.parametrize("bins", param_bins)
@pytest.mark.parametrize("range", param_range)
@pytest.mark.parametrize("density", param_density)
@pytest.mark.parametrize("use_weight", params_use_weight)
@pytest.mark.parametrize("dtype", param_dtype, ids=format_tc)
@pytest.mark.skipif(is_gaudi1(), reason="Histogram kernel is available for G2 and G3 only")
