...
_AUTOGRAD_H_FILE = """// Autogenerated file by {gen}. Do not edit directly!
...
_AUTOGRAD_DISPATCH_FUNCTION = """{return_type} {dispatch_op_name}(\n\t{inputs}) {{
...
_AUTOGRAD_CPP_FILE = """// Autogenerated file by {gen}. Do not edit directly!
