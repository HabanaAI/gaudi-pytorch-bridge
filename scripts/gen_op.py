...
OpGen = namedtuple_with_defaults(
    "OpGen",
    "tree, xtree, rwxtree, func, xfunc, lazy_code, hpuop_code, dtype_def, cname, sig, rwsig, cppsig, funsig, mapsig, aten_sig, dispatch, default, op_base_class",
)
...
def generate_code(ctx, tree, rwxtree, fname, aten_sig, sig, rwsig, params):
    ...
    return dtype_def, lazy_code, hpuop_code, hpuop_class, ctxop.get_op_base_class()
...
def get_hpu_wrapper(fndef, ctx):
    ...
    if requires_registration(fndef) and get_aten_opname(aten_sig) in ctx.op_data:
        dtype_def, lazy_code, hpuop_code, cname, op_base_class = generate_code(
