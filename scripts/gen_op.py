...
def generate_autocast_ops(fgens, args):
    ...
    replacements = (("::std::tuple<at::Tensor,at::Tensor>", "tuple_2_tensors"),
                    ("::std::tuple<at::Tensor,at::Tensor,at::Tensor>", "tuple_3_tensors"),
                    ("::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor>", "tuple_4_tensors"),
                    ("::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor>", "tuple_5_tensors"),
                    ("::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor>", "tuple_6_tensors"),
                    ("::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,int64_t>", "tuple_4_tensors_int64"),
                    ("::std::tuple<at::Tensor,at::Tensor,double,int64_t>", "tuple_2_tensors_double_int64"),
                    ("::std::tuple<at::Tensor,at::Tensor,at::Tensor,::std::vector<at::Tensor>>", "tuple_3_tensors_vector"),
                    ...
                    ("::std::tuple<at::Tensor,::std::vector<at::Tensor>,::std::vector<at::Tensor>>", "tuple_tensor_2_vectors"),
                    ("SymIntArrayRef", "IntArrayRef"), ("c10::SymInt", "int64_t"))

    blocklist = ("_cummax_helper", "_cummin_helper", "fused_moving_avg_obs_fake_quant",
                 "_fused_moving_avg_obs_fq_helper", "_fused_adam")

    def op_to_skip(function_name, op_name):
        return (function_name.endswith(("_out", "_")) or
                any(s in function_name for s in ("_.", "cuda", "cudn")) or
                op_name in blocklist)
    ...
    def get_registration(fgen, op_name):
        ...
        return op_registration.format(function_name = function_name, op_name = op_name,
                                                signature = signature)
