...
def gen_manual_op_registrations(fgens, hputype):
    overrides = parse_local_overrides(hputype)
    print(
        "{} function manual overrides in {}".format(len(overrides), args.hputype),
        file=sys.stdout,
    )
...
def generate(args):
    ...
    manual_torch_regs = gen_manual_op_registrations(fgens_manual, args.hputype)
    ...
    print(
        _CPP_HEADER.format(
            ...
            manual_torch_regs=manual_torch_regs,
        ),
