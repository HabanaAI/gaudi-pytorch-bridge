...
bool func(torch::jit::Stack &stack, bool is_dynamic) {
  if (stack.size() == 4) {
    ...
    if (ivalue_arr[0].isTensor() ) {
      ...
      c10::optional<c10::IValue> storage_offset_opt = storage_offset.toOptional<c10::IValue>();
      c10::optional<int64_t> storage_offset_opt_out;
      if (storage_offset_opt.has_value()) {
          ...
          storage_offset_opt_out = c10::optional<int64_t>(storage_offset_opt_in_base);
      } else {
