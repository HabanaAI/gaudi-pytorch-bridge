...
bool func(torch::jit::Stack &stack, bool is_dynamic) {
  if (stack.size() == 3) {
    ...
    if (ivalue_arr[0].isTensor() && ivalue_arr[1].isDouble() ) {
      ...
      c10::optional<c10::IValue> generator_opt = generator.toOptional<c10::IValue>();
      c10::optional<at::Generator> generator_opt_out;
      if (generator_opt.has_value()) {
          ...
          generator_opt_out = c10::optional<at::Generator>(generator_opt_in_base);
      } else {
