...
if make_changes_in_folders.count("tpc_fuser") > 0 and (make_changes_in_file == "" or make_changes_in_file == op_file):
    ...
    def writeHeader(file_buf):
        ...
        file_buf.write("/**\n")
        file_buf.write("* Copyright (c) 2021-2024 Intel Corporation\n")
        file_buf.write("*\n")
        file_buf.write('* Licensed under the Apache License, Version 2.0 (the "License");\n')
        file_buf.write("* you may not use this file except in compliance with the License.\n")
        file_buf.write("* You may obtain a copy of the License at\n")
        file_buf.write("*     http://www.apache.org/licenses/LICENSE-2.0\n")
        file_buf.write("*\n")
        file_buf.write("* Unless required by applicable law or agreed to in writing, software\n")
        file_buf.write('* distributed under the License is distributed on an "AS IS" BASIS,\n')
        file_buf.write("* WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\n")
        file_buf.write("* See the License for the specific language governing permissions and\n")
        file_buf.write("* limitations under the License.\n")
        file_buf.write("*/\n")
        file_buf.write("//===----------------------------------------------------------------------===//\n")
        file_buf.write("//\n")
...
if make_changes_in_folders.count("tpc_fuser") > 0 and (
    ...
    op_test_hpp_file_buf.write("/**\n")
    op_test_hpp_file_buf.write("* Copyright (c) 2021-2024 Intel Corporation\n")
    op_test_hpp_file_buf.write("*\n")
    op_test_hpp_file_buf.write('* Licensed under the Apache License, Version 2.0 (the "License");\n')
    op_test_hpp_file_buf.write("* you may not use this file except in compliance with the License.\n")
    op_test_hpp_file_buf.write("* You may obtain a copy of the License at\n")
    op_test_hpp_file_buf.write("*     http://www.apache.org/licenses/LICENSE-2.0\n")
    op_test_hpp_file_buf.write("*\n")
    op_test_hpp_file_buf.write("* Unless required by applicable law or agreed to in writing, software\n")
    op_test_hpp_file_buf.write('* distributed under the License is distributed on an "AS IS" BASIS,\n')
    op_test_hpp_file_buf.write("* WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\n")
    op_test_hpp_file_buf.write("* See the License for the specific language governing permissions and\n")
    op_test_hpp_file_buf.write("* limitations under the License.\n")
    op_test_hpp_file_buf.write("*/\n")
    op_test_hpp_file_buf.write("//===----------------------------------------------------------------------===//\n")
    op_test_hpp_file_buf.write("\n")
...
if make_changes_in_folders.count("tpc_fuser") > 0 and (
    ...
    op_test_cpp_file_buf.write("/**\n")
    op_test_cpp_file_buf.write("* Copyright (c) 2021-2024 Intel Corporation\n")
    op_test_cpp_file_buf.write("*\n")
    op_test_cpp_file_buf.write('* Licensed under the Apache License, Version 2.0 (the "License");\n')
    op_test_cpp_file_buf.write("* you may not use this file except in compliance with the License.\n")
    op_test_cpp_file_buf.write("* You may obtain a copy of the License at\n")
    op_test_cpp_file_buf.write("*     http://www.apache.org/licenses/LICENSE-2.0\n")
    op_test_cpp_file_buf.write("*\n")
    op_test_cpp_file_buf.write("* Unless required by applicable law or agreed to in writing, software\n")
    op_test_cpp_file_buf.write('* distributed under the License is distributed on an "AS IS" BASIS,\n')
    op_test_cpp_file_buf.write("* WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\n")
    op_test_cpp_file_buf.write("* See the License for the specific language governing permissions and\n")
    op_test_cpp_file_buf.write("* limitations under the License.\n")
    op_test_cpp_file_buf.write("*/\n")
    op_test_cpp_file_buf.write("//===----------------------------------------------------------------------===//\n")
    op_test_cpp_file_buf.write("\n")
